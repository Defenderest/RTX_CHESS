...
public class RTX_CHESS : ModuleRules
{
    public RTX_CHESS(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "UMG", "Http", "Json", "JsonUtilities", "OnlineSubsystem", "OnlineSubsystemSteam", "Steamworks", "Sockets", "Networking", "Niagara" });
